...
description: >-
  小说状态自同步与记忆沉淀技能。在章节定稿后，自动提炼故事 10+ 大维度变动（含开放式自定义），回写更新 current_state.md、推进 timeline.md、同步 chekhov_guns.md 伏笔池、misunderstandings.md 误会台账与 character_growth_arcs.md 心智台账，并打下版本快照。适用场景：状态同步、更新状态机、推进时间线、同步伏笔、沉淀记忆、打快照。
---
